  ...
  return (
    <div className="validation-container">
      ...
      <p style={{ color: '#666', fontSize: '14px', marginBottom: '25px', textAlign: 'center' }}>
        Hello {studentName}, an OTP has been sent to your registered email.
      </p>
      ...
      <button className="back-btn" onClick={() => window.location.href = '/LogIn/Student_LogIn/index.html'}>Back</button>
    </div>
  );
}
